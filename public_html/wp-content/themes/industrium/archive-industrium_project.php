...
$columns_number = industrium_get_theme_mod('project_archive_columns_number');
$posts_per_page = industrium_get_theme_mod('project_archive_posts_per_page');
        ...
        <div class="content">
            ...
            <div class="content-inner">
                ...
                <div class="archive-listing">
                    <div class="archive-listing-wrapper project-listing-wrapper project-grid-listing<?php echo ( isset($columns_number) && !empty($columns_number) ? ' columns-' . esc_attr($columns_number) : '' ); ?>">
                        <?php
                            while( $query->have_posts() ){
                                $query->the_post();
                                get_template_part('content', 'industrium_project');
                            };
                            wp_reset_postdata();
                        ?>
                    </div>
