...
$columns_number = industrium_get_theme_mod('service_archive_columns_number');
$posts_per_page = industrium_get_theme_mod('service_archive_posts_per_page');
        ...
        <div class="content">
            ...
            <div class="content-inner">
                ...
                <div class="archive-listing">
                    <div class="archive-listing-wrapper service-listing-wrapper service-grid-listing<?php echo ( isset($columns_number) && !empty($columns_number) ? ' columns-' . esc_attr($columns_number) : '' ); ?>">
                        <?php
                            while( $query->have_posts() ){
                                $query->the_post();
                                get_template_part('content', 'industrium_service', array('excerpt_length' => industrium_get_theme_mod('service_archive_excerpt_length')));
                            };
                            wp_reset_postdata();
                        ?>
                    </div>
